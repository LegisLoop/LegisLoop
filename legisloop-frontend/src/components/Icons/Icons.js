 ...
 ****************************************************************
 * List of svg icons used.
 ****************************************************************
 * Last Updated: February 19, 2025.
 ***************************************************************/
export const HeartIcon = () => (
    <svg className="size-6" width="24" height="24"
...
export const CompassIcon = () => (
    <svg className="size-8 text-custom-red" viewBox="0 0 24 24" fill="none" stroke="currentColor"
...
export const GlobalAmericasIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"
         className="size-6">
        <path strokeLinecap="round" strokeLinejoin="round"
...
export const CalendarEventIcon = () => (
    <svg className="size-8 text-custom-red" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2"
         stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
        <path stroke="none" d="M0 0h24v24H0z"/>

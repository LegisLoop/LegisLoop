...
function SearchBar({ setSearchTerm, setActiveLevel, setActivePolicy }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex ml-auto w-auto">
            <div className="flex w-full bg-gray-100 px-4 py-2 rounded outline outline-transparent border
